...
const LeftMenu = () => {
  return (
    ...
    <div className='left-menu w-[305px] h-[1315px] float-start inline-block'>
      ...
      <div className='about grid justify-items-center mt-[48px]'>
        <span className='w-[220px] h-[25px] mb-4'>
          <p className='w-auto px-1 bg-[#FFB400] inline-flex justify-center items-center'>Age:</p>
          <p className='float-end'>24</p>
        </span>

        <span className='w-[220px] h-[25px] mb-4'>
          <p className='w-auto px-1 bg-[#FFB400] inline-flex justify-center items-center'>Residence:</p>
          <p className='float-end'>BD</p>
        </span>

        <span className='w-[220px] h-[25px] mb-4'>
          <p className='w-auto px-1 bg-[#FFB400] inline-flex justify-center items-center'>Freelance:</p>
          <p className='float-end text-[#7EB942]'>Available</p>
        </span>

        <span className='w-[220px] h-[25px] mb-4'>
          <p className='w-auto px-1 bg-[#FFB400] inline-flex justify-center items-center'>Address:</p>
      ...
      <div className='languages grid justify-items-center mt-[35px]'>
        ...
        <span className='w-[220px] h-[25px] mb-4 font-light text-sm'>
          <p className='w-auto inline-flex justify-center items-center'>Bangla</p>
        ...
        <span className='w-[220px] h-[25px] mb-4 font-light text-sm'>
          <p className='w-auto inline-flex justify-center items-center'>English</p>
        ...
        <span className='w-[220px] h-[25px] mb-4 font-light text-sm'>
          <p className='w-auto inline-flex justify-center items-center'>Spanish</p>
      ...
      <div className='Skill grid justify-items-center mt-[35px]'>
        ...
        <span className='w-[220px] h-[25px] mb-4 font-light text-sm'>
          <p className='w-auto inline-flex justify-center items-center'>WorldPress</p>
          <p className='float-end'>85%</p>
          <div className='
          mt-2
          percent bg-gradient-to-r 
      ...
      <div className='Extra-skills grid justify-items-center mt-[30px]'>
        ...
        <img src='/public/image/icons.png' className='w-auto h-4 inline-flex justify-center items-center mr-2'></img>
          <p className='w-auto inline-flex justify-center items-center'>Bootstrap, Materialize</p>
        </span>

        <span className='w-[220px] h-[25px] mb-1 font-light text-sm'>
        <img src='/public/image/icons.png' className='w-auto h-4 inline-flex justify-center items-center mr-2'></img>
          <p className='w-auto inline-flex justify-center items-center'>Stylus, Sass, Less</p>
        </span>

        <span className='w-[220px] h-[25px] mb-1 font-light text-sm'>
        <img src='/public/image/icons.png' className='w-auto h-4 inline-flex justify-center items-center mr-2'></img>
          <p className='w-auto inline-flex justify-center items-center'>Gulp, Webpack, Grunt</p>
        </span>

        <span className='w-[220px] h-[25px] mb-1 font-light text-sm'>
        <img src='/public/image/icons.png' className='w-auto h-4 inline-flex justify-center items-center mr-2'></img>
          <p className='w-auto inline-flex justify-center items-center'>GIT Knowledge</p>
        </span>
      </div>
      {/* End Extra-skills-left-menu */}
      <div className='btn flex justify-center mt-4'>
        <img src='/public/image/CV2.png'></img>
      </div>
    </div>
  )
}
